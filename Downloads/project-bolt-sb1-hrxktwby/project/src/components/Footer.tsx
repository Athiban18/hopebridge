      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">finity</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your trusted partner for online shopping. Discover amazing products with secure payments and fast delivery.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@akfinity.com</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 AKfinity. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
